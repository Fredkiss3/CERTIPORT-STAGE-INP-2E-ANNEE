...
$reservations = "active";
$res_non_notees = get_user_reservations($_SESSION["uid"]);
$res_notees = get_user_reservations($_SESSION["uid"], true);
?>
...
<section id="main-content">
    <section class="wrapper">
        <div style="padding-left: 16px; margin: 2rem auto;" class="text-center">
            <?php if (get_nbre_reserve_non_respecte($_SESSION["uid"]) == 1): ?>
                <div class="alert alert-danger h4">
                    Vous n'avez pas respecté <b>1</b> réservation.
                </div>
            <?php endif; ?>
            <?php if (can_reserve() and !max_reserve_atteint() and !salles_fermees()) : ?>
            ...
            <?php elseif (max_reserve_atteint()): ?>
                <div class="alert alert-danger">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-danger btn-xs"
                                            onclick="goto('<?php echo url("student/cancel_reservation.php"). '?id='. $r['idResult'] ?>')">annuler
                                    </button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
