...
$res_non_notees = get_all_reservations();
$res_notees = get_all_reservations(true);
//    dd(array($res_non_notees, $res_notees));
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-primary btn-xs"
                                            onclick="goto('<?php echo url(($_SESSION["niveau_acces"] > 1 ? "admin" : "surveillant") . '/note_reservation.php') . '?id=' . $r["idResult"] ?>')">
                                        Noter
                                    </button>

                                    <?php if ($_SESSION["niveau_acces"] > 1) : ?>
